...
export function PageLanding() {
  ...
  return(
    <main className="w-full min-h-screen bg-[url(/assets/background-mix.svg)] bg-center bg-cover bg-no-repeat">
      <div className="w-full flex justify-end items-center bg-purple py-5 pr-10 lg:pr-20">
        <Button light onClick={() => navigate('/counselor/start')}>Login as Conselor</Button>
      </div>
      <div className="min-h-[calc(100vh-92px)] py-10 bg-[#F6F5FDB2] backdrop-blur-lg text-black text-center flex flex-col justify-center items-center">
